...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="{{ route('admin.settings.pterodactyl-region.update') }}" method="POST">
                <div class="box">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ $discord }}" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-primary pull-left"><i class="fa fa-fw fa-link"></i> Discord Help</a>
                    </div>
                </div>
            </form>
        </div>
