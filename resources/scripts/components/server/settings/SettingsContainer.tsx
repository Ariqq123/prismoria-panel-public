...
import ServerBackgroundBox from '@/components/server/settings/ServerBackgroundBox';
...
export default () => {
    ...
    const sftpUsername = sftp.username && sftp.username.trim().length > 0 ? sftp.username.trim() : `${username}.${id}`;
