                ...
                {!lookupTarget ? (
                    ...
                    <div css={tw`space-y-4`}>
                        <div css={tw`grid grid-cols-1 xl:grid-cols-3 gap-4`}>
                            <div css={tw`xl:col-span-1 rounded-lg border border-neutral-700 bg-neutral-900/80 p-4`}>
                                ...
                                <div css={tw`mt-4 text-xs text-neutral-400`}>
                            ...
                            <div css={tw`xl:col-span-2 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3`}>
                                {renderMetric(
                                    'Players',
                        ...
                        <div css={tw`grid grid-cols-1 xl:grid-cols-2 gap-4`}>
                            <div css={tw`rounded-lg border border-neutral-700 bg-neutral-900/80 p-4`}>
