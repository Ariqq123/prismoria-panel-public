 ...
 * @property \Illuminate\Database\Eloquent\Collection|\Pterodactyl\Models\ExternalPanelConnection[] $externalPanelConnections
 * @property int|null $external_panel_connections_count
    ...
    CanResetPasswordContract
{
    ...
    public function externalPanelConnections(): HasMany
    {
        return $this->hasMany(ExternalPanelConnection::class);
    }
