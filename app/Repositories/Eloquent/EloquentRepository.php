...
abstract class EloquentRepository extends Repository implements RepositoryInterface
{
     ...
     *
     * Sentinel-first behavior: returns deleted row count, including 0 when no
     * record matches, without throwing not-found exceptions.
     */
     ...
     *
     * Sentinel-first behavior: returns deleted row count, including 0 when no
     * records match, without throwing not-found exceptions.
     */
     ...
     *
     * Legacy convenience helper retained for compatibility with older callers.
     */
