...
{
    private const AUTH_CONFIRMATION_EXPIRED_MESSAGE = 'The authentication token provided has expired, please refresh the page and try again.';
    ...
    public function __invoke(LoginCheckpointRequest $request): JsonResponse
    {
        ...
        if (!$this->hasValidSessionData($details)) {
            $this->sendFailedLoginResponse($request, null, self::AUTH_CONFIRMATION_EXPIRED_MESSAGE);
        }
