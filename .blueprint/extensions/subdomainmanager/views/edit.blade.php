                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="provider" name="provider" class="form-control">
                                <option value="cloudflare" {{ ($domain->provider ?? 'cloudflare') === 'cloudflare' ? 'selected' : '' }}>Cloudflare</option>
                                <option value="min3" {{ ($domain->provider ?? 'cloudflare') === 'min3' ? 'selected' : '' }}>Min3</option>
                            </select>
                        </div>
                        <div class="form-group">
